...
console.log(`7 is ${myFavoriteNumbers[6]}`)
...
switch (letterGrade) {
  case "A":
    ...
    break;
  case "B": // Value of foo matches this criteria; execution starts from here
    console.log("THIS IS B");
  // Forgotten break! Execution falls through
  case "C": // no break statement in 'case 0:' so this case will run as well
    console.log(1);
